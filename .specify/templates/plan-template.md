...
**Primary Dependencies**: FastAPI, uv
**Storage**: [if applicable, e.g., PostgreSQL, CoreData, files or N/A]
**Testing**: pytest
**Target Platform**: Linux server
**Project Type**: [single/web/mobile - determines source structure]
**Performance Goals**: p95 < 100ms for simple endpoints, 500 concurrent WebSocket connections
**Constraints**: [domain-specific, e.g., <200MB memory, offline-capable or NEEDS CLARIFICATION]
